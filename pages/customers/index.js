    ...
    <Layout>
      <div>
        <div className="flex justify-between items-center">
          ...
          <div className="flex w-10/12 overflow-auto items-center gap-x-4 justify-end">
            <div>
              <p className="fw-500 fs-400 text-primary whitespace-nowrap">
                Referral Summary
              </p>
            </div>
            ...
            <div className="px-4 flex items-center gap-x-2 h-8 bg-white rounded-md shadow">
              <p className="fs-400 text-gray-500 whitespace-nowrap">
                Paid Bonus
              </p>
