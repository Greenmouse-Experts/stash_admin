...
import CustomerSave from "@/components/customers/features/CustomerSave";
import CustomerSpend from "@/components/customers/features/CustomerSpend";
import CustomerLoan from "@/components/customers/features/CustomerLoan";
import ProfileInfo from "@/components/customers/features/ProfileInfo";
import Transaction from "@/components/customers/features/Transaction";
      ...
      <div>
        <div className="md:flex items-center justify-between">
          <div className="flex items-center">
            <Image
              src="https://res.cloudinary.com/greenmouse-tech/image/upload/v1680003695/Stash/profile_rl7x7s.jpg"
              alt="banner"
              width={200}
              height={100}
          ...
          <div className="flex gap-x-4 mt-6 md:mt-0 items-center">
            ...
            <div className="fw-500 border rounded border-gray-300">
              <Menu>
                ...
                <MenuList>
                <div className="my-3 outline-none fw-500 text-black" role="button">Restrict from:</div>
            ...
            <div className="fw-500 border rounded border-gray-300">
              <Menu>
                ...
                <MenuList>
                    <div className="my-3 outline-none fw-500 text-black" role="button">Flag from:</div>
                  <MenuItem>Withdrawals</MenuItem>
                  <MenuItem>Transfer</MenuItem>
                </MenuList>
              </Menu>
