...
const SpenderDataPage = () => {
  return (
    <Layout>
      <div>
        <div className="flex lg:pt-6 mb-12 items-end">
          <div className="text-3xl fw-600">Top Spender</div>
          <div className="flex text-gray-500 items-center lg:ml-7">
            <p className="fs-700">
              <Link href="/admin/save">Spend</Link>
            </p>
            <MdKeyboardArrowRight className="text-xl mx-5" />
            <p className="text-primary fw-500">Top Spender</p>
          </div>
        </div>
...
export { getLayout };
export default SpenderDataPage;
