...
} from "@/services/api/spendSlice";
import SpendSkeleton from "@/components/UI/Skeleton-load/spendSkel";

const SpendPage = () => {
  const { data, isLoading, isSuccess, isError } = useGetSpendAnalyticsQuery();
                ...
                <div className="">
                  <div className="p-8 pl-0 bg-white shade rounded-md">
                    ...
                    <div className="mt-8 pl-2">
                      <TotalSpendChart data={data?.data} />
                    </div>
                  </div>
                  <div className="p-8 pl-0 mt-6 bg-white shade rounded-md">
                    ...
                    <div className="mt-8 pl-2">
                      <SuccessfulCatChart data={data?.data} />
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="p-6 pt-8 bg-white shade rounded-md">
                  <div className="flex items-start md:items-center justify-between">
                    ...
                    <div className="md:flex items-center text-end lg:text-left">
                      <Link
                        href="spend/top-spender"
                        className="fs-700 text-primary fw-500 mr-6"
                      >
                        See All
                      </Link>
