          ...
          <table className="min-w-full text-left">
            ...
            <tbody>
              ...
              <tr className="font-medium">
                ...
                <td className="align-middle fs-500 whitespace-nowrap px-4 py-4 text-left">
                  <p className="px-3 py-1 rounded text-center bg-red-50 text-red-600 border border-red-500">
                    Failed
                  </p>
                </td>
                <td className="align-middle fs-500 whitespace-nowrap px-4 py-4 text-left">
              ...
              <tr className="font-medium">
                ...
                <td className="align-middle fs-500 whitespace-nowrap px-4 py-4 text-left">
                  <p className="px-3 py-1 rounded text-center bg-yellow-50 text-yellow-600 border border-yellow-500">
                    Pending
                  </p>
                </td>
                <td className="align-middle fs-500 whitespace-nowrap px-4 py-4 text-left">
