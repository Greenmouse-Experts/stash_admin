            ...
            <table className="min-w-full text-left">
                <thead className="font-medium">
                    <tr>
                        ...
                        <th scope="col" className="px-4 text-gray-400 align-middle py-3 whitespace-nowrap text-left">Interest rate</th>
                    </tr>
                </thead>
                <tbody>
                    <tr className="font-medium">
                        ...
                        <td className="align-middle fs-500 whitespace-nowrap px-4 py-4 text-left">10,000</td>
                        <td className="align-middle fs-500 whitespace-nowrap px-4 py-4 text-left">3 months</td>
                        <td className="align-middle fs-500 whitespace-nowrap px-4 py-4 text-left">Mar 02, 23 - 9:22</td>
                        <td className="align-middle fs-500 whitespace-nowrap px-4 py-4 text-left">Mar 02, 23 - 9:22</td>
                        <td className="align-middle fs-500 whitespace-nowrap px-4 py-4 text-left"><p className='px-3 py-1 rounded text-center bg-green-50 text-green-600 border border-green-500'>Withdrawn</p></td>
                        <td className="align-middle fs-500 whitespace-nowrap px-4 py-4 text-left">14%</td>
                    </tr>
                    <tr className="font-medium">
